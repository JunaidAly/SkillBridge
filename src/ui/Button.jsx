function Button({ children, variant = "primary", onClick, className = "" }) {
  const baseStyles = "font-poppins font-medium px-6 py-2 rounded-lg transition-all";

  const variants = {
    primary: "bg-teal text-white hover:opacity-90",
    secondary: "text-black hover:text-teal text-[700] border-2 border-[#D0D0D0] hover:bg-dark-blue hover:text-white",
